    ...
    <section id="request" className="relative bg-[var(--bed)] py-24 md:py-32">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            href="/request"
            className="rounded-full bg-[var(--cta-bg)] px-8 py-3.5 text-sm font-semibold font-body uppercase tracking-wide text-[var(--cta-fg)] transition-colors hover:opacity-90"
          >
            REQUEST INFORMATION
          </a>
          <a
            href="tel:+18773565823"
            className="liquid-glass-strong rounded-full px-8 py-3.5 text-sm font-semibold font-body uppercase tracking-wide text-[var(--ink)] transition-colors hover:bg-white/5"
          >
            CALL US
          </a>
        </div>
