    ...
    <main className="min-h-screen bg-[#0a0a0b]">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          >
            <p className="mb-4 inline-flex liquid-glass rounded-full px-3.5 py-1 text-xs font-medium font-body text-white">Careers</p>
      ...
      <section className="pb-24 md:pb-32">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
          >
            <h2 className="mb-4 font-heading italic text-2xl tracking-tight text-white">Open roles</h2>
            <p className="mx-auto mb-8 max-w-lg text-sm font-body font-light leading-relaxed text-white/60">
            ...
            <a
              ...
              className="inline-flex rounded-full bg-white px-8 py-3.5 text-sm font-semibold font-body text-black transition-colors hover:bg-white/90"
            >
