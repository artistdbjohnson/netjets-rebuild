    ...
    <main className="min-h-screen bg-[#0a0a0b]">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="mb-4 inline-flex liquid-glass rounded-full px-3.5 py-1 text-xs font-medium font-body text-white">Solutions</p>
      ...
      <section className="pb-24 md:pb-32">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="grid gap-6 md:grid-cols-3">
            {["Share", "Lease", "Hour-based access"].map((title) => (
              <div key={title} className="liquid-glass rounded-2xl p-8 transition-colors">
                <h2 className="mb-3 font-heading italic text-lg tracking-tight text-white">{title}</h2>
          ...
          <div className="mt-12">
            <a href="/programs" className="inline-flex liquid-glass-strong rounded-full px-7 py-3 text-sm font-medium font-body text-white transition-colors hover:bg-white/5">
              Explore Programs
            </a>
          </div>
        </div>
