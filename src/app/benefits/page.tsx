      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-6 max-w-2xl text-lg font-body font-light text-white/60">
      ...
      <section className="pb-24 md:pb-32">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="liquid-glass rounded-2xl p-8 md:p-10">
            ...
            <p className="mt-3 max-w-2xl text-sm font-body font-light text-white/60 md:text-base">
